  ...
  return (
    <div className="flex flex-col h-full bg-slate-50 font-display">
      <header className="bg-white px-8 py-6 border-b border-slate-200">
        <h2 className="text-3xl font-extrabold tracking-tight text-slate-900">Pengaturan KDS</h2>
        <p className="text-slate-500 text-sm mt-1">Konfigurasi tampilan dan peringatan Anda</p>
      </header>

      <div className="p-8 max-w-2xl">
        <div className="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden">
          <div className="p-6 border-b border-slate-100">
            <h3 className="font-bold text-lg text-slate-900 mb-4">Peringatan & Suara</h3>
            <div className="space-y-4">
               <label className="flex items-center justify-between cursor-pointer">
                 <span className="text-slate-700">Suara Pesanan Baru</span>
                 <input type="checkbox" defaultChecked className="toggle" />
               </label>
               <label className="flex items-center justify-between cursor-pointer">
                 <span className="text-slate-700">Peringatan Pesanan Terlambat (&gt;15m)</span>
                 <input type="checkbox" defaultChecked className="toggle" />
               </label>
            </div>
          </div>
          ...
          <div className="p-6">
            ...
            <div className="space-y-4">
               ...
               <label className="flex items-center justify-between cursor-pointer">
                 <span className="text-slate-700">Kelompokkan Item Sama</span>
                 <input type="checkbox" defaultChecked className="toggle" />
               </label>
            </div>
          </div>
